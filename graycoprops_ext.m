...
allStats = {'Contrast','Correlation1','Energy','Homogeneity','Correlation2','Auto'};
...
for p = 1 : numGLCM
  ...
  for k = 1:numStats
    ...
    switch name
     ...
     case 'Correlation1'
      stats.(name)(p) = calculateCorrelation_1(tGLCM,r,c);
      
     case  'Correlation2'
      stats.(name)(p) = calculateCorrelation_2(tGLCM,r,c);
...
%-----------------------------------------------------------------------------
function Corr = calculateCorrelation_1(glcm,r,c)
% References: 
...
warning(ws);
%-----------------------------------------------------------------------------
function Corr=calculateCorrelation_2(glcm,r,c)
% Calculate the mean and standard deviation of a pixel value in the row
% direction direction. e.g., for glcm = [0 0;1 0] mr is 2 and Sr is 0.
mr = meanIndex(r,glcm);
Sr = stdIndex(r,glcm,mr);
